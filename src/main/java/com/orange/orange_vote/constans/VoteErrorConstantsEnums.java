...
public enum VoteErrorConstantsEnums implements BaseEnum {
    VOTE_NOT_FOUND(0, "Error.Vote.NotFound"), VOTE_ALREADY(1, "Error.Vote.isVoted"), VOTEOPTION_NOT_FOUND(2,
        "Error.Vote.Option.NotFound"), VOTEOPTION_MULTISELECT(3,
            "Error.Vote.Option.MultiSelect"), VOTEOPTION_NOT_ALLOW_ADD(4, "Error.Vote.Option.NotAllowAdd");
